...
function Blogcards() {
  return (
    <>
      <section className='text-black bg-cover opacity-90 bg-blur-sm'>
        <div className=''>
          <h1 className='text-6xl font-bold text-sky-800 text-center flex items-center justify-center mb-20 pt-28'>Culinary Blogs</h1>
          <h1 className='text-3xl font-bold text-slate-700 text-center flex items-center justify-center mb-36'>Savor the flavors and discover the stories behind your favorite dishes.</h1>
        </div>
        <div className='flex flex-col justify-center items-center space-y-4 text-white lg:grid grid-cols-3 lg:justify-items-center'>
          ...
          <div className='bg-slate-600 h-128 w-80 rounded-lg p-5 hover:border'>
            ...
            <p className='pl-6'>Best Street Food Stalls in [City Name]</p>
          ...
          <div className='bg-slate-600 h-128 w-80 rounded-lg p-5 hover:border'>
            <Image src={"/images/3dimg.webp"}
              ...
              alt={"img"} />
            <h1 className='text-2xl font-bold ml-5'>Title:</h1>
            <p className='pl-6'>Hidden Coffee Shops with the Best Brews in [City Name]</p>
            <h1 className='text-2xl font-bold ml-5'>Description:</h1>
          ...
          <div className='bg-slate-600 h-128 w-80 rounded-lg p-5 hover:border'>
            <Image src={"/images/3dimg.webp"}
              ...
              alt={"img"} />
            <h1 className='text-2xl font-bold ml-5'>Title:</h1>
            <p className='pl-6'>Top 5 Desserts You Must Try in [City Name]</p>
            <h1 className='text-2xl font-bold ml-5'>Description:</h1>
